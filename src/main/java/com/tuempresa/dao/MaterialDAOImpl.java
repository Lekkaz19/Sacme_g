...
public class MaterialDAOImpl extends GenericDAOImpl<Material, Integer> implements MaterialDAO {
    ...
    public List<Material> findByGrupo(Grupo grupo) {
        TypedQuery<Material> q = getEntityManager().createQuery("SELECT m FROM Material m WHERE m.grupo = :grupo",
                Material.class);
    ...
    public List<Material> findByUnidad(Unidad unidad) {
        TypedQuery<Material> q = getEntityManager().createQuery("SELECT m FROM Material m WHERE m.unidad = :unidad",
                Material.class);
    ...
    public List<Material> findByNombre(String nombre) {
        TypedQuery<Material> q = getEntityManager().createQuery("SELECT m FROM Material m WHERE m.nombre LIKE :nombre",
                Material.class);
    ...
    public List<Material> findByCodcorrelativo(String codcorrelativo) {
        TypedQuery<Material> q = getEntityManager()
